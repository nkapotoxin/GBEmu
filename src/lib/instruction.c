...
instruction instructions[0x100] = {
    // Something intresting at D6/E6/E9/EE/F6/FE
    ...
    [0x27] = {IN_DAA},
    [0x28] = {IN_JR, AM_R_D8, RT_NONE, RT_NONE, CT_Z},
    ...
    // 0x3x
    [0x30] = {IN_JR, AM_R_D8, RT_NONE, RT_NONE, CT_NC},
    ...
    [0x37] = {IN_SCF},
    [0x38] = {IN_JR, AM_R_D8, RT_NONE, RT_NONE, CT_C},
